...
BLOCK_TOP = 3050000
BLOCK_WIDTH = 4060000
BLOCK_COL_GAP = 190000
BLOCK_ROW_STEP = 535000
...
def add_block_page(slide, screenshots: list[Path]) -> None:
    ...
    positions = [
        ...
        (BLOCK_LEFT + BLOCK_WIDTH + BLOCK_COL_GAP, BLOCK_TOP),
        (BLOCK_LEFT, BLOCK_TOP + BLOCK_ROW_STEP),
        (BLOCK_LEFT + BLOCK_WIDTH + BLOCK_COL_GAP, BLOCK_TOP + BLOCK_ROW_STEP),
        (BLOCK_LEFT, BLOCK_TOP + BLOCK_ROW_STEP * 2),
        (BLOCK_LEFT + BLOCK_WIDTH + BLOCK_COL_GAP, BLOCK_TOP + BLOCK_ROW_STEP * 2),
    ]
